...
- 🤖 **AI 요약 기능** - Google Gemini로 화자별 내용 요약
- 📋 **타임라인 기반 UI** - 화자별 썸네일과 시간 순서 표시
- 🎯 **화자별 분석** - 각 화자의 발언 내용과 요약 제공
- ⚡ **성능 최적화** - 중첩 expander 오류 해결 및 UI 개선
...
### 🤖 AI 요약 및 분석 ⭐ **신규**
- **Google Gemini AI**: 최신 생성형 AI로 지능적 요약
...
- [Google Gemini](https://deepmind.google/technologies/gemini/) - AI 요약
